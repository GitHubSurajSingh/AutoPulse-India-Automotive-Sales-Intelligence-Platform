...
```bash
# Download the autopulse/ folder
# Open index.html in any browser
# Use any demo account from the left panel
# Data stores in browser localStorage
```

### Option 2 — Host free on Netlify
```
1. Go to https://app.netlify.com/drop
2. Drag the entire autopulse/ folder
3. ✅ Live HTTPS URL in 30 seconds
```
...
For production with a real shared database:

### Step 1 — Create project
1. Go to **https://app.supabase.com** → New Project
2. Name: `autopulse`, Region: Singapore (closest to India)
3. Set a password → **Create Project**
...
- `sales` table with indexes
- Row Level Security policies
- Aggregate views (`sales_by_brand`, `sales_by_state`, etc.)
...
### Step 4 — Configure
Open `app.js` and edit lines 1–2:
```js
